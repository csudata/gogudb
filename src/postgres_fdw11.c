						  ...
						  int subplan_index)
{
	...
	{
		case CMD_INSERT:
			GogudeparseInsertSql(&sql, rte, resultRelation, rel,
							 targetAttrs, doNothing, returningList,
							 &retrieved_attrs);
			break;
		case CMD_UPDATE:
			GogudeparseUpdateSql(&sql, rte, resultRelation, rel,
							 targetAttrs, returningList,
							 &retrieved_attrs);
			break;
		case CMD_DELETE:
			GogudeparseDeleteSql(&sql, rte, resultRelation, rel,
							 returningList,
							 &retrieved_attrs);
			break;
		default:
						   ...
						   ResultRelInfo *resultRelInfo)
{
	...
	/* Construct the SQL command string. */
	GogudeparseInsertSql(&sql, rte, resultRelation, rel, targetAttrs, doNothing,
						...
						Cost *p_startup_cost, Cost *p_total_cost)
{
	...
	if (fpinfo->use_remote_estimate)
	{
		...
		conn = GoguGetConnection(fpinfo->user, false, false);
