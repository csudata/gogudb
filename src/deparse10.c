 ...
 */
void
GogudeparseInsertSql(StringInfo buf, PlannerInfo *root,
				 Index rtindex, Relation rel,
 ...
 */
void
GogudeparseUpdateSql(StringInfo buf, PlannerInfo *root,
				 Index rtindex, Relation rel,
 ...
 */
void
GogudeparseDeleteSql(StringInfo buf, PlannerInfo *root,
				 Index rtindex, Relation rel,
				 List *returningList,
				 List **retrieved_attrs)
{
