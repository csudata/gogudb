...
SELECT * FROM gogudb_partition_list ORDER BY partition; /* should contain 3 partitions */
...
BEGIN
	LOOP
		...
		SELECT processed
		FROM gogudb_concurrent_part_tasks
...
SELECT count(*) FROM gogudb_concurrent_part_tasks;
